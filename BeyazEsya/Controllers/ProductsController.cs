...
namespace BeyazEsya.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(EsyaDbContext context)
        {
            _context = context;
        }
        ...
        {
            var esyaDbContext = _context.products.Include(p => p.Brand).Include(p => p.Category);
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Sku,BrandId,CategoryId,Description,Price,IsActive,Created")] Products products)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,Sku,BrandId,CategoryId,Description,Price,IsActive,Created")] Products products)
        {
